-- Same signatures as before, so CREATE OR REPLACE keeps owners and grants.
-- Both projections gain garment_type: the detail page and fit calculator read
-- it off the product instead of resolving it through the category.
...
-- list_shop_products: full body copied from 20260910010000 with p.garment_type added.

      ...
      child: ListView(
        ...
        children: [
          ...
          ProductBasicInfoEditor(
            ...
            selectedMaterialPreset: formData.selectedMaterialPreset,
            materialOtherController: formData.materialOtherController,
            selectedFitPreset: formData.selectedFitPreset,
            fitOtherController: formData.fitOtherController,
